...
\setcounter{figure}{0}
%
\textcolor{red}{Pregunta con hilo infinito y un segmento cargado, con un punto de pivot en un extremo. Preguntar por el torque }
\textcolor{red}{Pregunta: para un disco de radio R y carga total Q en el plano xy con su centro en el origen, se calcula el módulo del campo eléctrico en un punto P sobre el eje z y se obtiene el valor E_1. Por otro lado, si en lugar del disco se tiene un anillo con el mismo radio y la misma carga total Q, el valor que se obtiene para el módulo del campo eléctrico en el punto P es E_2. ¿Cuál es mayor, E_1 o E_2?}
%
\begin{Exercise}
