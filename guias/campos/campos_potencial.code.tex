...
\begin{Exercise}\label{p:potencial02}
  Un dipolo de cargas $\pm q$ y separación $d$ está colocado sobre el eje $\vu{i}$ como se muestra en la figura \ref{f:potencial02}.\par\medskip 
  \textit{a}) Verifique que el potencial en el punto $P$ es:
  \begin{flalign*}
    V_P &= \dfrac{1}{4\pi\varepsilon_o} \dfrac{p}{x^2-\dfrac{d^2}{4}}\, ,
  \end{flalign*}
  donde \mbox{$p=qd$} es el momento dipolar de este sistema de cargas.\par\medskip  
...
\begin{Exercise}\label{p:potencial06}
  \textbf{\raisebox{.5pt}{\textcircled{\raisebox{-1.2pt} {E}}}} Para la barra mostrada en la figura \ref{f:potencial06}, con densidad lineal de carga $\lambda$:\par\medskip 
  \textit{a}) Verifique que el potencial eléctrico en el punto $P$ es:
  \begin{flalign*}
...
\begin {figure*}%[!hbtp]
  ...
  \begin{adjustbox}{width=\textwidth}
    \input{campos/img/em_fig_equipotenciales_buscar_E.code.tex}
  \end{adjustbox}
...
\begin{center}
  ...
  \end{tikzpicture}
  \captionof{figure}{Problema \ref{p:potencial13}\label{f:potencial13}}
\end{center}
%
\begin{Exercise}
...
\begin{center}
  \begin{tikzpicture}[scale=0.5]
    ...
    \draw [blue, -{latex}] (0,0)--(1.4,1.4);
    \draw (0.6,1.35) node[blue] {$\va*{r}_a$};
