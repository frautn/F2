...
\begin{Exercise}
  ...
  \begin{itemize}
    \item Carga $A$:\par $q_A = \SI{300}{\nano\coulomb}$ en $\va*{r}_A = (1.0;2.0;0.0)\,\text{m}$
    \item Carga $B$:\par $q_B = \SI{-20}{\nano\coulomb}$ en $\va*{r}_B = (3.0;1.0;-1.0)\,\text{m}$
  \end{itemize}
...
\begin{Answer}
  \begin{minipage}[t]{.4\textwidth}
    \textit{a}) $\va*{E}_A = (6\,\vu{i} + 1\,\vu{j} -4\,\vu{k})\text{ N/C}$;\\ $\va*{E}_B = (27\,\vu{i} + 29\,\vu{j} -1\,\vu{k})\text{ N/C}$\\ \textit{b}) $|\va*{F}_A| = \SI{10.9E-6}{\newton}$ \\ \textit{c}) $|\va*{F}_B| = \SI{14.4E-6}{\newton}$
  \end{minipage}
\end{Answer}
%
